<div class="navbar-bg" style=background-color:darkgreen></div>
<nav class="navbar navbar-expand-lg main-navbar">
  ...
  <ul class="navbar-nav navbar-right">
    ...
    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
      <img alt="image" src="{{asset('assets/img/avatar/kuntilanak.png')}}"class="rounded-circle mr-1">
      <div class="d-sm-none d-lg-inline-block">Hi, Rheza Ganteng</div></a>
